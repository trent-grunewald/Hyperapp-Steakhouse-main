      ...
      <div class="container contact-container">
       ...
       <h1 class="contact-title">COME ENJOY OUR MEAT!</h1>
        <div class="container contact-box">
          <div class="col-md-6">
            <h5 class="contact-location">{state.globalState.companyInfo.location} <span>{state.globalState.companyInfo.state}</span></h5>
            <h5 class="contact-address">{state.globalState.companyInfo.directions}<br></br> {state.globalState.companyInfo.location} {state.globalState.companyInfo.zip}</h5>
            <h5 class="contact-email">Email: <span>{state.globalState.companyInfo.email}</span></h5>
            <h1 class="contact-underline">       </h1>
          </div>
          <div class="col-md-6">
            <h5 class="contact-call">Call for reservations:</h5>
            <h1 class="contact-number">{state.globalState.companyInfo.phone}</h1>
